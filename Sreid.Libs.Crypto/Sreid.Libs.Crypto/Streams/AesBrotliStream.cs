...
public class AesBrotliStream(
    Stream stream,
    AesBrotliStreamMode aesBrotliStreamMode,
    byte[] aesKey,
...
) : Stream
{
    ...
    /// </returns>
    public override bool CanRead => aesBrotliStreamMode == AesBrotliStreamMode.Unpack;
    ...
    /// </returns>
    public override bool CanWrite => aesBrotliStreamMode == AesBrotliStreamMode.Pack;
    ...
    private void InitializePackStream()
    {
        ...
        using var aes = AesBrotliStream.InitializeAes(
            aesKey,
